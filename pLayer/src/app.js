...
let app = new Vue({
  ...
  <b-container style="background-color:#E1F3F6;">
    <b-row>
      ...
      <b-col align="right">
        <b-dropdown class="m-2" split right split-variant="outline-danger" @click="signOut" v-if="signedIn" variant="outline-dark">
        ...
        <b-tabs card align="center">
          ...
          <b-tab title="create" active>
            <b-row><b-col align="center" v-show="!busy">
              ...
              <hr>
              <h6><b>DISC<b-icon icon="disc-fill"></b-icon>GRAPHY</b></h6>
            </b-col></b-row>
          </b-tab>
          <b-tab title="outbox">
            <b-row><b-col align="center">
