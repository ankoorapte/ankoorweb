    ...
    <b-tabs>
      <b-tab title="News">
        <div id="news_list" role="tablist">
          ...
          <news-item v-if="news.length > 1" :content="news_content[1]" :headline="news_head[1]"></news-item>
          <news-item v-if="news.length > 2" :content="news_content[2]" :headline="news_head[2]"></news-item>
          <news-item v-if="news.length > 3" :content="news_content[3]" :headline="news_head[3]"></news-item>
          <news-item v-if="news.length > 4" :content="news_content[4]" :headline="news_head[4]"></news-item>
          <news-item v-if="news.length > 5" :content="news_content[5]" :headline="news_head[5]"></news-item>
          <news-item v-if="news.length > 6" :content="news_content[6]" :headline="news_head[6]"></news-item>
          <news-item v-if="news.length > 7" :content="news_content[7]" :headline="news_head[7]"></news-item>
          <news-item v-if="news.length > 8" :content="news_content[8]" :headline="news_head[8]"></news-item>
          <news-item v-if="news.length > 9" :content="news_content[9]" :headline="news_head[9]"></news-item>
          <news-item v-if="news.length > 10" :content="news_content[10]" :headline="news_head[10]"></news-item>
          <news-item v-if="news.length > 11" :content="news_content[11]" :headline="news_head[11]"></news-item>
          <news-item v-if="news.length > 12" :content="news_content[12]" :headline="news_head[12]"></news-item>
          <news-item v-if="news.length > 13" :content="news_content[13]" :headline="news_head[13]"></news-item>
          <news-item v-if="news.length > 14" :content="news_content[14]" :headline="news_head[14]"></news-item>
        </div>
      </b-tab>
